...
const ProfileUpdate = (props) => {
  ...
  return (
    <section className="p-12 bg-[#DDD] border border-[#C75D2C] text-[#C75D2C] bg-opacity-90 w-[900px] sm:w-full sm:p-6 md:p-12">
      ...
      <div className="mb-4 mt-6 flex justify-between items-center w-2/5 sm:w-11/12 md:w-2/3">
      ...
      <p className="text-md mb-4 w-2/5 sm:w-11/12 md:w-2/3">
        Email adresa: {userData.email}
      </p>
      <div className="my-4 flex justify-between items-center w-2/5 sm:w-11/12 md:w-2/3">
      ...
      <div
        className="bg-[#C75D2C] rounded-md cursor-pointer px-4 py-2 mt-4 text-white block w-2/5 sm:w-11/12 md:w-2/3"
        onClick={() =>
